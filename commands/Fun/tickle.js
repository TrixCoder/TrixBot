...
module.exports.run = async (client, msg, args) => {
    ...
    let res = await axios.get(`https://api.tenor.com/v1/search?q=anime tickle&key=${config.TENOR_API}&contentfilter=medium`);
    ...
    let embed = new MessageEmbed()
        .setDescription(`**${msg.author.toString()} is tickling ${user.toString()}**`)
