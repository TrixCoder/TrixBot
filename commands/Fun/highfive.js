...
module.exports.run = async (client, msg, args) => {
    ...
    let res = await axios.get(`https://api.tenor.com/v1/search?q=anime highfive&key=${config.TENOR_API}&contentfilter=medium`);
    ...
    let embed = new MessageEmbed()
        .setDescription(`**${msg.author.toString()} highfives with ${user.toString()}**`)
...
module.exports.help = {
    ...
    description: 'Give someone highfive ',
    category: "Fun"
}